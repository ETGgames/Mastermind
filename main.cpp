...
struct mm_solver{
	...
	void getFeedbackForAllPossibilities(){//doing this to stop having to calculate give feedback every time and hence speed things up
		/// write your implementation here
		...
		for(int i = 0; i < masterList.size(); i++){
			...
			//std::cout << "\nnext guess looped";
			for(int j = 0; j < codeList.size(); j++){//find partitions
				//std::cout << "||||\n";
				int black_hits = 0;
				int white_hits = 0;
...
int main(){
	...
	int numberOfRoundsToAverage = 10000;
